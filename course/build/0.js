...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactConsultPageModule", function() { return ContactConsultPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contact_consult__ = __webpack_require__(683);
...
var ContactConsultPageModule = (function () {
    function ContactConsultPageModule() {
    }
    ContactConsultPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__contact_consult__["a" /* ContactConsultPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__contact_consult__["a" /* ContactConsultPage */]),
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_2__contact_consult__["a" /* ContactConsultPage */]]
        })
    ], ContactConsultPageModule);
    return ContactConsultPageModule;
}());

//# sourceMappingURL=contact-consult.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContactConsultPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__(684);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(147);
 ...
 */
var ContactConsultPage = (function () {
    function ContactConsultPage(navCtrl, formBuilder, http) {
    ...
    ContactConsultPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad User');
    };
    ContactConsultPage.prototype.send = function (message) {
        var _this = this;
        if (message && message !== ' ') {
            var messageData = {
            ...
            this.reply
                ...
                _this.myreply.text = data.text;
                console.log(_this);
            });
            setTimeout(function () {
                var replyData = {
                    userId: _this.toUs._id,
                    pic: 'assets/img/logo2.jpg',
                    text: _this.myreply.text
                };
    ...
    ContactConsultPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    ], ContactConsultPage.prototype, "content", void 0);
    ContactConsultPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-contact-consult',template:/*ion-inline-start:"F:\ionic\and\src\pages\contact-consult\contact-consult.html"*/'<!--\n\n  Generated template for the ContactConsultPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>咨询留意</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <div *ngFor="let message of messages" class="message-wrapper">\n\n    \n\n    <div *ngIf="toUs._id === message.userId">\n\n      <img [src]="toUs.pic" alt="客服" class="message-pic left">\n\n      <div class="triangle-left left"></div>\n\n      <div class="chat-bubble left" >\n\n        <div class="message"  [innerHTML]="message.text" >\n\n        </div>\n\n        <div class="message-detail">\n\n        </div>\n\n      </div>\n\n      <span class="span-name left">{{toUs.username}}</span>\n\n      \n\n    </div>\n\n    <div *ngIf="user._id === message.userId">\n\n      <img [src]="user.pic" alt="我" class="message-pic right">\n\n      <div class="triangle-right"></div>\n\n      <div class="chat-bubble right">\n\n        <div class="message" [innerHTML]="message.text">\n\n\n\n        </div>\n\n        <div class="message-detail">\n\n        </div>\n\n      </div>\n\n      <span class="span-name right">{{user.username}}</span>                  \n\n    </div>\n\n    <div class="cf"></div>\n\n\n\n\n\n  </div>\n\n\n\n</ion-content>\n\n<ion-footer>\n\n  <form [formGroup]="messageForm" (submit)="send(chatBox)">\n\n    <ion-item no-lines>\n\n      <ion-input formControlName="message" [(ngModel)]="chatBox" placeholder="发送咨询信息……"></ion-input>\n\n      <button ion-button clear (click)="send(chatBox)" item-end>\n\n        <ion-icon name="send"></ion-icon>\n\n      </button>\n\n    </ion-item>\n\n  </form>\n\n</ion-footer>\n\n\n\n\n\n\n\n\n\n<!-- <ion-content>\n\n  <ion-list>\n\n    <ion-item>\n\n      <ion-label>姓名</ion-label>\n\n      <ion-input>\n\n\n\n      </ion-input>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>手机</ion-label>\n\n      <ion-input>\n\n\n\n      </ion-input>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>邮箱</ion-label>\n\n      <ion-input>\n\n\n\n      </ion-input>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>QQ</ion-label>\n\n      <ion-input>\n\n\n\n      </ion-input>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>留意信息</ion-label>\n\n  <!-- <textarea class="input-textarea" name="" id="" cols="30" rows="10" placeholder=\'输入内容\'></textarea> -->\n\n<!-- </ion-item>\n\n  </ion-list>\n\n  <textarea class="input-textarea" name="" id="" cols="30" rows="10" placeholder=\'输入内容\'></textarea>\n\n\n\n</ion-content> -->-->\n\n'/*ion-inline-end:"F:\ionic\and\src\pages\contact-consult\contact-consult.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_0__angular_forms__["a" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Http */]])
    ], ContactConsultPage);
    return ContactConsultPage;
}());

//# sourceMappingURL=contact-consult.js.map
